...
import { CalendarDays, Eye, FileText, Globe, Hash, Package } from 'lucide-react';
...
export function CategoryViewerRow({ item }: { item: Category }) {
          ...
          <div className="space-y-6 pb-6">
            ...
            {(!item.children || item.children.length === 0) && (
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">Không có sub category nào</p>
                </CardContent>
              </Card>
            )}
